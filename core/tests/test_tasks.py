...
from core.tasks import check_and_fulfill_course_milestone, MIN_COMPLETION_PERCENT, fulfill_course_milestone_task
from core.receivers import fulfill_milestone_on_block_completion
