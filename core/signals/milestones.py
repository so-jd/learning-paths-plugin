...
def _execute_milestone_check_sync(user_id, course_key_str):
    ...
    try:
        ...
        from core.tasks import check_and_fulfill_course_milestone
...
def _enqueue_milestone_task_async(user_id, course_key_str):
    ...
    try:
        from django.contrib.auth import get_user_model
        from core.tasks import fulfill_course_milestone_task
...
def check_and_trigger_learning_path_credentials(user_id, course_key_str):
    ...
    from core.models import LearningPath, LearningPathStep, LearningPathEnrollment
    from core.credentials import check_learning_path_completion_for_credential
    ...
    try:
        ...
        for step in learning_path_steps:
            ...
            if eligible:
                ...
                from core.tasks import generate_learning_path_credential
